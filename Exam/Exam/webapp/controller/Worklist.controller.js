...
sap.ui.define([
		...
		"Exam/ControlTask_Shutsilin111/model/formatter",
		"sap/ui/model/Filter",
		"sap/ui/model/FilterOperator"
	], function (BaseController, JSONModel, formatter, Filter, FilterOperator) {
		"use strict";

		return BaseController.extend("Exam.ControlTask_Shutsilin111.controller.Worklist", {
			...
			onPressSayHello: function() {
				if (!this.oDialogCreate) {
					this.oDialogCreate = new Dialog({
						...
						content: [
							new sap.m.Text({
								text: "Шутилин Илья Вячеславович"
							})
						],
