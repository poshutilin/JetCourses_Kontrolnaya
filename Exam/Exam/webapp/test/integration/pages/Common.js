sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("Exam/ControlTask_Shutsilin111/app", ".html");
		...
		return Opa5.extend("Exam.ControlTask_Shutsilin111.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["Exam/ControlTask_Shutsilin111/localService/mockserver"], function (mockserver) {
